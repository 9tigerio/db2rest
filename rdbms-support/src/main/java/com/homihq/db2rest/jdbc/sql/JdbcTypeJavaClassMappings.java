...
public class JdbcTypeJavaClassMappings {
    ...
    public int determineJdbcTypeCodeForJavaClass(Class<?> cls) {
        ...
        log.debug(
                "JDBC type code mapping not known for class [" + cls.getName()
                        + "]; using custom code [" + specialCode + "]"
        );
        return specialCode;
    }
    ...
    public Class<?> determineJavaClassForJdbcTypeCode(Integer typeCode) {
        ...
        log.debug(
                "Java Class mapping not known for JDBC type code {}}; using java.lang.Object",
                typeCode
        );
        return Object.class;
    }
