...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE user PURGE'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; /
CREATE TABLE user (
...
BEGIN
  IF :NEW.id IS NULL THEN SELECT user_seq.NEXTVAL INTO :NEW.id FROM dual; END IF;
END;
/
