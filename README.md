...
| Release              | Download                                                                    |
|----------------------|-----------------------------------------------------------------------------|
| 1.0.3                | [DB2Rest](https://download.db2rest.com/db2rest-1.0.3.jar)                   |
| Oracle9i - 1.0.3     | [DB2Rest-Oracle9i](https://download.db2rest.com/db2rest-oracle9i-1.0.3.jar) |
| 1.0.3 (Docker Image) | ` docker pull kdhrubo/db2rest:v70 `                                         |
