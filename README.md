...
|----------------------|-----------------------------------------------------------------------------------|
| 1.1.4                | [DB2Rest-1.1.4](https://download.db2rest.com/db2rest-1.1.4.jar)                   |
| Oracle9i - 1.1.4     | [DB2Rest-Oracle9i-1.1.4](https://download.db2rest.com/db2rest-oracle9i-1.1.4.jar) |
